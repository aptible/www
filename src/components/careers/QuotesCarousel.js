...
const ALL_QUOTES = [
  ...
  },
  {
    ...
    quote:
      'I admire my colleagues’ thoughtfulness, energy, and grit. Folks here are thoughtful in their approach to things, from ‘How will what I say land on the other person?’ to ‘How will this architectural decision limit the flexibility of our product a year from now?’. And yet, we’re still biased toward action: My teammates have an amazing energy around getting stuff done. Lastly, I admire my colleagues’ grit: When we set our mind to something, nothing gets in our way.',
  },
  {
    author: 'Elyssa May Cendana, Sales Team',
    authorSlug: 'elyssa-cendana',
    quote:
      'Aptible is always looking for ways to improve, both externally and internally. I appreciate that we encourage our customers and employees to share feedback — and that we actually take that feedback into account.',
  },
  {
    author: 'David Wen, Engineering Team',
    authorSlug: 'david-wen',
    quote:
      'I’m proud that our products enable other organizations to solve problems they otherwise might not have the resources to tackle. This makes me feel like we have an outsized, positive effect on others.',
  },
  {
    author: 'Mia Lopez, Growth Team',
    authorSlug: 'mia-lopez',
    quote:
      'It makes me proud that Aptible offers a product that helps tackle an issue as important as data security. I think the information a company collects is one of its greatest assets. And because that information holds so much power, keeping it safe is paramount.',
  },
  {
    author: 'Sarah Veirs, Customer Success Team',
    authorSlug: 'sarah-veirs',
    quote:
      'I admire the commitment to the mission in my colleagues. Everyone is very much a team player and is dedicated to going above and beyond not just for our customers, but for each other. We love winning together and you can feel it.',
  },
  {
    author: 'Zachary Starr-Glasser, People Operations Team',
    authorSlug: 'zachary-starr-glasser',
    quote:
      'I really admire that everyone lifts one another up. Being remote, I think it would be easy to be siloed and only interact during meetings, but everyone at Aptible really cares about supporting each other. I love how much people participate in our #Victory and #Thanks Slack Channels.',
  },
];
            ...
            {ALL_QUOTES.map((quote, idx) => (
              <div key={idx} className={styles.quote}>
                <div className={styles.authorPhoto}>
                  <img
                    src={this.photoForEmployee(quote.authorSlug)}
                    alt={quote.author}
                  />
                </div>
                <h4>
