    ...
    return (
      <div
        className={`${styles.product} ${styles.comply} ${
          this.props.expanded ? styles.expanded : ''
        }`}
      ...
      >
        ...
        <div className={styles.title}>
          ...
          <p className="L">Monitor your security and automate compliance.</p>
        </div>
        ...
        {!this.props.expanded && (
          <React.Fragment>
            ...
            <div className={styles.seeDetails}>
              ...
              <img
                src={detailsArrow}
                className={styles.seeDetailsArrow}
                alt="Pricing arrow"
              />
            </div>
          </React.Fragment>
          ...
          <div className={styles.complyFormContainer}>
            ...
            <div className={styles.complySidebar}>
              <CheckmarkUnorderedList>
                ...
                <li>
                  Continuously monitor people, device, and asset compliance
                  status
                </li>
                ...
                <li>
                  Update your risk assessment as your company changes
                  automatically
                </li>
              </CheckmarkUnorderedList>
            </div>
