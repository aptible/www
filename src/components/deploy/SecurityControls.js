  ...
  <Grid rows="3">
    ...
    <div className={styles.steps}>
      ...
      <ol>
        ...
        <li className={styles.aptible}>Implement app-level security controls</li>
    ...
    <div className={styles.stepsArrow}>
      <svg width="312" height="766" viewBox="0 0 312 766" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M292 762V123C292 56.7258 238.274 3 172 3H0" stroke="#33C69F" strokeWidth="5" />
        <path d="M293.999 757.612L294.204 757.612L294.35 757.468L311.5 740.558L311.5 746.07L291.999 765.298L272.5 746.07L272.5 740.558L289.648 757.468L289.794 757.612L289.999 757.612L293.999 757.612Z" fill="#33C69F" stroke="#33C69F" />
      </svg>
    </div>

    <div className={styles.useAptible}>
      <h1>Or you can use Aptible and skip all of these steps.</h1>
      <ArrowButton to="/" text="See All Features" />
    </div>
  </Grid>
);
