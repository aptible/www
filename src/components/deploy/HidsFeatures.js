...
const monitoringIcon = (
  ...
  >
    <path
      d="M47.1338 29.1069L54 35.5"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
    />
    <path
      d="M9 38L14.6713 31L18.7222 36L25.2037 25L32.4954 35L37 28.534"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
    />
    ...
    />
    <path
      d="M42 32C45.3137 32 48 29.3137 48 26C48 22.6863 45.3137 20 42 20C38.6863 20 36 22.6863 36 26C36 29.3137 38.6863 32 42 32Z"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
      strokeLinecap="square"
...
const responseIcon = (
  ...
  >
    ...
    />
    <path
      d="M3.083 44.328L0 33L11.642 34.511L3.083 44.328Z"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
      strokeLinecap="square"
    />
    <path
      d="M6.22055e-09 24C-0.000116855 19.1969 1.6463 14.5389 4.66472 10.8026C7.68314 7.06639 11.8911 4.47779 16.587 3.46845C21.2829 2.45911 26.1829 3.09003 30.47 5.25602C34.757 7.42202 38.172 10.9922 40.1455 15.3712C42.119 19.7501 42.5318 24.6733 41.3149 29.3198C40.098 33.9662 37.3251 38.0551 33.4586 40.9047C29.592 43.7542 24.8654 45.1922 20.067 44.9788C15.2686 44.7654 10.6884 42.9136 7.09 39.732"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
    />
...
const reportIcon = (
  ...
  >
    <path
      d="M37 1.5708H1V37.0227H37V1.5708Z"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
      strokeLinecap="square"
    />
    <path
      d="M31 6.40527H7V15.2682H31V6.40527Z"
      stroke="#FFB607"
      strokeWidth="2"
      strokeMiterlimit="10"
      strokeLinecap="square"
    ...
    <Grid>
      ...
      <div className={styles.bullets}>
        ...
        <div className={styles.bullet}>
          ...
          <p>
            You can optionally subscribe to the Deploy HIDS Compliance Report to
            provide your customers and auditors evidence that you are using HIDS
            to monitor, analyze, and remediate security events.
          </p>
        </div>
      </div>
