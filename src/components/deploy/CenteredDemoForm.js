...
export default () => (
  <div className={styles.container}>
    ...
    <p className="L">Complete audits faster with well-documented controls, clear audit trails for third parties, and all of the security and compliance features you need get certified.</p>
