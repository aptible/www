...
const DefaultOptInText = () => (
  <>
    I consent to receiving Aptible marketing emails.{' '}
...
class WebinarForm extends React.Component {
  ...
  submit = () => {
    ...
    submitMarketoForm(this.props.formId, payload, () => {
      ...
      new Image().src =
        'https://px.ads.linkedin.com/collect/?pid=42067&conversionId=2644156&fmt=gif';
    });
  };
  ...
  render() {
    return (
      <div className={styles.container}>
            ...
            <div className={styles.marketingConsent}>
              <label>
                <input
                  ...
                  onChange={e =>
                    this.fieldChanged('marketingConsent', e.target.value)
                  }
                />
                <span>
        ...
        {this.state.finished && (
          <p>
            Thank you for registering. Check your email for the webinar details.
          </p>
        )}
      </div>
    );
