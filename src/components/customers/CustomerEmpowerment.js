    ...
    <Grid rows="2">
      <div className={`${styles.bullet} ${styles.bulletLeft} ${styles.bulletTop}`}>
        ...
        <p className="L">
          ...
          success. We want to see our customers grow into mature teams that
          excel at protecting data. 
        </p>
      </div>
      ...
      <div className={`${styles.bullet} ${styles.bulletRight} ${styles.bulletTop}`}>
        ...
        <p className="L">
          We help our customers by solving hard problems in multiple domains. Our
          customers look to us as guides, and we weave our deep legal and technical
          experience into our software and services. Our products teach you how
          to get better as you use them.
        </p>
      </div>
