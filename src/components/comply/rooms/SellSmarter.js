    ...
    <Grid>
      ...
      <div className={styles.boxes}>
        <div className={styles.box}>
          ...
          <p>
            See which of your customers is engaging with your security
            documentation
          </p>
          <p>
            Gain insight into which security documents are most
            viewed/downloaded
          </p>
        </div>
        <div className={styles.box}>
          <h6>Activity Feed</h6>
          <p>
            See document uploads, downloads, version changes, and room visits in
            one place
          </p>
        </div>
      </div>
