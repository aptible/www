      ...
      <AptibleLayout>
        ...
        <Grid rows="2">
          <div style={{ gridColumn: "1 / span 7" }}>
            ...
            <div className={heroStyles.heroItem}>
              <p className="XL">
                Accelerate your startup journey and bring secure, compliant applications to
                market faster by hosting and running them on Aptible. With $5,000 in credits,
                you can run your containerized  applications and databases for free on Aptible
                for up to 6 months.* 
              </p>
            </div>
        ...
        <Grid>
          <div style={{ gridColumn: "1 / span 7" }}>
              ...
              steps={
                [
                  [
                    ...
                    {
                      title: 'Secure, resilient host, middleware and network architecture',
                      text:
                  ...
                  }, {title: null, text: null }, {title: null, text: null }]
                ]
              }
            />
            ...
            <div style={{ marginLeft: "calc(100%&1/13)", width: "calc(100%*8/13)", marginTop: "128px" }}>
              <Faq
                title="Frequently Asked Questions"
                questions={[
                  {
                    title: 'How do I become eligible for these credits?',
                    question: <p className="">
                      Businesses have to show proof of active AWS Activate membership.
                      <a onClick={() => setShowForm(true)} href="#">Submit your info</a> and a member
                      of the Aptible team will reach out with more information.
                    </p>
                  },
                  {
                    title: 'Do these credits expire?',
                    question: <p>
                      The credits expire 45 days from signing up if you’ve not activated
                      an Aptible Dedicated Stack. If a Dedicated Stack is activated within
                      45 days of signing up, the credits last indefinitely until you exhaust them.
                    </p>
                  },
                  {
                    ...
                    question: (<div>
                      <p className="">
                        Aptible is an application development and hosting platform,
                        with a focus on security and compliance. The Aptible pricing model is
                        a pay-as-you-go subscription model primarily based on utilized compute
                        resources, encrypted disk storage, backups and the provisioning of a
                        Dedicated Stack.
                      </p>

                      <p><a href="/pricing-plans">Learn more about Aptible’s pricing.</a></p>
                      
                      <p>
                        On average, with $5,000, customers can expect to run their workloads on
                        Aptible for free for 4-6 months. This duration can be longer or shorter
                        depending on the volume of your compute and storage utilization.
                      </p>
                    </div>)
                  },
                  {
                    ...
                    question: <p>
                      A dedicated stack is a deployment environment where you are the sole
                      tenant, to which Aptible automatically applies and maintains the
                      required security configurations and SLAs needed for security, compliance
                      and availability. Each Aptible dedicated Stack runs in its own private VPC.
                      Dedicated Stacks are ideal for when customers want to ingest regulated data
                      like PHI, ensure HIPAA and HITRUST compliance, or have stringent availability
